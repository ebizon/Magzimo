...
class Acs
{
    ...
    *-------------------------------------------------------------------------------------*/
	...
	function get_group_name($post_id)
	{	
		 global $wpdb;
		 $meta_id = $wpdb->get_var("SELECT post_id FROM $wpdb->postmeta WHERE meta_key = 'post_order' AND meta_value LIKE '%$post_id%'");
		 $group_name = $wpdb->get_var("SELECT post_title FROM $wpdb->posts WHERE post_status = 'publish' AND ID = '$meta_id'");
	...
	{	
		 global $wpdb;
		$group_name = $wpdb->get_results("SELECT post_title FROM $wpdb->posts WHERE post_status = 'publish' AND post_type = 'acs'");
		 return $group_name;
	}
